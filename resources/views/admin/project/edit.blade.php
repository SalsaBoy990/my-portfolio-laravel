                ...
                <form action="{{ route('project.update', $project->id)}}" method="POST"
                    ...
                    <div class="mb-5">
                        ...
                        <select
                          ...
                          focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                            ...
                            @if ($value === 'hu')
                            <option {{ $project->language === $value ? "selected": "" }} value="{{
                    ...
                    <div class="mb-5">
                        ...
                        <x-jet-input id="title"
                            ...
                            type="text" name="title" :value="old('title') ?? $project->title" autofocus />
                    ...
                    <div class="mb-5">
                        ...
                        <x-jet-input id="client"
                            ...
                            type="text" name="client" :value="old('client') ?? $project->client" autofocus />
                    ...
                    <div class="mb-5">
                        ...
                        <textarea name="links" rows="5" id="project-links-editor"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ old('links') ?? $project->links }}</textarea>
                    ...
                    <div class="flex flex-col md:flex-row">
                        <div class="mb-5">
                            ...
                            <x-admin.image-preview :url="$project->cover_image_link" :alt="$project->title">
                    ...
                    <div>
                        <x-jet-button type="submit" class="inline-flex items-center px-4 py-2 mb-4 bg-blue-600 border border-transparent
                                ...
                                disabled:opacity-25 transition">{{ __("Update project") }}
                        </x-jet-button>
