<section class="skills mb-12 sm:mb-20">
    ...
    <div class="flex items-center flex-col mt-6">
        ...
        <h2 class="font-serif text-2xl sm:text-4xl text-white mt-3 mb-10 tracking-wide">Highlighted
            skills</h2>
    </div>
    ...
    <div
        ...
        <div class="box bg-main-800 rounded-md shadow-md">
            <h3 class="w-full h-16 text-left pl-8 border-b border-b-white12pc font-exo text-lg mobile:text-xl font-bold tracking-wide"
                style="line-height: 64px;">JavaScript development</h3>
        ...
        <div class="box bg-darkpurple rounded-md shadow-md">
            <h3 class="w-full h-16 text-left pl-8 border-b border-b-white12pc font-exo text-lg mobile:text-xl font-bold tracking-wide"
                style="line-height: 64px;">
                UI/UX design knowledge</h3>
            <div class="text-editor ml-8 mt-3 mr-4 leading-loose text-white87pc">
                <p>Completed the Digital Product Design course of UXStudio, in Budapest</p>
