    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul class="mt-6">
            <li
                ...
                <a class="inline-flex items-center w-full text-sm {{ request()->routeIs('dashboard') ? 'font-bold text-gray-800' : 'font-medium' }} transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                    href="{{ route('dashboard') }}">
