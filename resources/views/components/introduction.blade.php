<section class="introduction -mt-9 flex flex-col justify-center">
    ...
    <div class="flex flex-col sm:flex-row gap-5 pb-10 sm:pb-0 text-left justify-center items-start sm:items-center align-center z-10"
        style="min-height: 150px; margin: auto 0;">
        <img src="{{ asset('storage/images/andras.gulacsi.png') }}" class="h-156 w-156 ml-4 md:ml-0"
