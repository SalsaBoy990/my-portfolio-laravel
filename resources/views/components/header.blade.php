<header class="header flex items-center justify-center relative">
    ...
    <div class="brand absolute top-7 left-8 flex flex-row gap-2 items-center z-10">
        ...
        <span class="text-base sm:text-xl font-bold text-white tracking-wide font-exo">András
            Gulácsi</span>
    </div>

    <div class="top-action-buttons flex flex-row absolute top-8 right-2 sm:right-6 z-50 justify-end">
        <ul class="action-buttons z-50 text-right">
            <li class="pt-2.5 mb-2">
    ...
    <div class="hero-text text-left self-center justify-self-center z-10 px-6 sm:px-5 md:px-0">
        <h1
            ...
            A frontend & PHP Developer</h1>
        <p class="text-lg mobile:text-xl md:text-2xl text-white80pc font-medium">I create landing
            pages, websites, and
            e-commerce stores</p>
    ...
    <div class="header-image flex justify-center absolute top-4 bottom-0 h-full w-full z-0"
        ...
        <img src="{{ asset('storage/images/header.jpg') }}" class="object-cover" alt="">
    </div>
